...
def check_video_sources():
    ...
    video1_url = os.getenv("VIDEO1_URL", "https://youtube.com/shorts/qpClWOkC2rw?si=N6yVCRrqxiJmOaSG")
    video2_url = os.getenv("VIDEO2_URL", "https://youtube.com/shorts/qpClWOkC2rw?si=N6yVCRrqxiJmOaSG")
